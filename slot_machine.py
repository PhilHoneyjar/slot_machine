...
class SlotMachine:
    ...
    def simulation(self, spinCount, potAmount, betAmount):
        self.spincount, self.potAmt, self.betAmt = spinCount, potAmount, betAmount
        jackpots = 0
        ...
        if profit > 0:
            ...
            return f"{winningSpins} wins / {spinCount} spins. Simulated profit: {profit}. RTP: {returnToPlayer:.2f}"
        else: return f"{winningSpins} wins / {spinCount} spins. Simulated profit: $0.00. RTP: {returnToPlayer:.2f}"
